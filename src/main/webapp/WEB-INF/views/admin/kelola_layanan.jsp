        ...
        <div class="glass-card">
            ...
            <form action="${pageContext.request.contextPath}/admin/katalog" method="POST">
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                    <input type="text" name="nama" class="input-glass-form" placeholder="Nama Layanan (ex: Hair Spa)" required>
                    <input type="number" name="harga" class="input-glass-form" placeholder="Harga (ex: 150000)" required>
                </div>
                <textarea name="deskripsi" class="input-glass-form" placeholder="Deskripsi Singkat Layanan" rows="2"></textarea>
                <button type="submit" class="btn-glass" style="margin-top: 10px;">Simpan Layanan</button>
            </form>
        </div>

...
public class AdminController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (path.equals("/admin/promo")) {
            ...
            if ("delete".equals(action)) {
                katalogDAO.delete(Integer.parseInt(request.getParameter("id")));
            } else {
            ...
            if ("delete".equals(action)) {
                kapsterDAO.delete(Integer.parseInt(request.getParameter("id")));
            } else {
                kapsterDAO.save(new Kapster(request.getParameter("nama"), request.getParameter("spesialisasi")));
            }
